...
//            supervisorDetails.add(new Chunk(employer.getJobTitle, boldTextFont));
            ...
            Paragraph objectivesInfo = new Paragraph("Conformément aux objectifs visés pour ce stage, les tâches et les mandats suivants seront confiés à l’élève stagiaire :", boldTextFont);
...
// Add the responsibilities text
            ...
            responsibilitiesText.add(new Phrase("• fournir à l’entreprise tous les renseignements concernant les conditions spécifiques du programme d’études et du programme d’alternance travail-études;\n", normalTextFont));
            responsibilitiesText.add(new Phrase("• collaborer, au besoin, à la définition du plan de stage;\n", normalTextFont));
            responsibilitiesText.add(new Phrase("• effectuer un suivi de l’élève stagiaire pendant la durée du stage;\n", normalTextFont));
            responsibilitiesText.add(new Phrase("• fournir à l’entreprise les documents nécessaires à l’évaluation de l’élève stagiaire;\n", normalTextFont));
            responsibilitiesText.add(new Phrase("• collaborer avec l’entreprise pour résoudre des problèmes qui pourraient survenir en cours de stage, le cas échéant;\n", normalTextFont));
            responsibilitiesText.add(new Phrase("• conserver tous les dossiers de stage et les rapports des élèves;\n", normalTextFont));
            responsibilitiesText.add(new Phrase("• fournir à l’entreprise le formulaire d’attestation de participation à un stage de formation admissible après réception du formulaire « Déclaration relative au crédit d’impôt remboursable pour les stages ».\n", normalTextFont));

            responsibilitiesText.add(new Chunk("\nL’entreprise s’engage à :\n", boldTextFont));
            responsibilitiesText.add(new Phrase("• embaucher l’élève stagiaire aux conditions précisées dans la présente entente;\n", normalTextFont));
            responsibilitiesText.add(new Phrase("• désigner un superviseur de stage qui assurera l’encadrement de l’élève stagiaire pour toute la durée du stage;\n", normalTextFont));
            responsibilitiesText.add(new Phrase("• mettre en place des mesures d’accueil, d’intégration et d’encadrement de l’élève stagiaire;\n", normalTextFont));
            responsibilitiesText.add(new Phrase("• procéder à l’évaluation de l’élève stagiaire.\n", normalTextFont));
            responsibilitiesText.add(new Phrase("• retourner le formulaire « Déclaration des heures travaillées » dûment rempli.\n", normalTextFont));
            responsibilitiesText.add(new Phrase("• respecter les mesures de sécurités sanitaires provinciales en contexte de la pandémie Covid-19\n", normalTextFont));

            responsibilitiesText.add(new Chunk("\nL’élève s’engage:\n", boldTextFont));
            responsibilitiesText.add(new Phrase("• assumer de façon responsable et sécuritaire, les tâches qui lui sont confiées;\n", normalTextFont));
            responsibilitiesText.add(new Phrase("• respecter les politiques, règles et procédures de l’entreprise ainsi que l’horaire de travail au même titre qu’un employé;\n", normalTextFont));
            responsibilitiesText.add(new Phrase("• respecter les dates de début et de fin de stage;\n", normalTextFont));
            responsibilitiesText.add(new Phrase("• référer rapidement au responsable des stages au cégep toute situation problématique affectant le bon déroulement du stage;\n", normalTextFont));
            responsibilitiesText.add(new Phrase("• rédiger un rapport de stage et le soumettre au responsable des stages au cégep.\n", normalTextFont));
