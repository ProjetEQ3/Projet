...
public class GlucoseApplication implements CommandLineRunner {
	...
	private void createApplication(){
		studentService.addCv(10L, createFakePDF());
	...
	private CvFileDTO createFakePDF() {
		CvFileDTO hardCodedPDF = new CvFileDTO();
		hardCodedPDF.setFileName("cv_chawki_michaud.pdf");// Decode the Base64 string into a byte array
